...
/*     const postGoldBalance = await goldContract.balanceOf(aliceAddress);
  ...
  //   await expect(coreFacet.attack([9, 10], [30, 13], 50)).to.be.reverted;
  // });
  ...
  //   expect(
  //     parseInt(ethers.utils.formatUnits(tileUnitsAfterDeploy.units, 0))
  //   ).to.be.equal(
  //     parseInt(ethers.utils.formatUnits(prevUnitsOnTile.units, 0)) + 100
  //   );
  // });
  ...
  //   expect(
  //     parseInt(ethers.utils.formatUnits(goldInTailAtStart.gold))
  //   ).to.be.greaterThan(
  //     parseInt(ethers.utils.formatUnits(goldInTailAfterclaim.gold))
  //   );
  ...
  //   await expect(coreFacet.claimGold([10, 11])).to.be.revertedWith(
  ...
  //   const specialAttackNFT = await specialContract.balanceOf(
  //     aliceAddress,
  //     nftID
  //   );
  //   const afterGoldBalance = await goldContract.balanceOf(aliceAddress);
  //   expect(parseInt(ethers.utils.formatUnits(specialAttackNFT, 0))).to.be.equal(
  //     amount
  //   );
  //   expect(parseInt(ethers.utils.formatUnits(afterGoldBalance))).to.be.equal(
  //     parseInt(ethers.utils.formatUnits(prevGoldBalance)) - nftPrice
  //   );
  // });
